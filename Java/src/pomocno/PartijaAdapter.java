...
public class PartijaAdapter implements JsonSerializer<Partija>, JsonDeserializer<Partija> {
    ...
    public Partija deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        switch (brojIgraca){
            case 2:
                return context.deserialize(json, Class.forName("model.PartijaDvaIgraca"));
            case 3:
                return context.deserialize(json, Class.forName("model.PartijaTriIgraca"));
            case 4:
                return context.deserialize(json, Class.forName("model.PartijaDvaPara"));
            default:
                return null;
        }
